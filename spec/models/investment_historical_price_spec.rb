...
describe InvestmentHistoricalPrice do
  describe 'many prices' do
    let!(:db_prices) do
      {   0 => FactoryGirl.create(:investment_historical_price, date: Date.current,       close: 400, adjustment: 1),
        365 => FactoryGirl.create(:investment_historical_price, date: Date.current - 365, close: 900, adjustment: 1),
        366 => FactoryGirl.create(:investment_historical_price, date: Date.current - 366, close: 200, adjustment: 1)
      }
    end
