# RailsAdmin config file. Generated on December 28, 2013 11:50
...
RailsAdmin.config do |config|
  ...
  #   # You can copy this to a 'rails_admin do ... end' block inside your investment.rb model definition

  #   # Found associations:

  #     configure :prices, :has_many_association 
  #     configure :dividends, :has_many_association 
  #     configure :splits, :has_many_association 
